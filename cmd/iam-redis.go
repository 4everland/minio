...
func (sys *IAMSys) InitByRedis(ctx context.Context, objAPI ObjectLayer, redisClient *redis.Client, iamRefreshInterval time.Duration) {
	...
	sys.initStoreByRedis(objAPI, redisClient)
...
// initStoreByRedis initializes IAM stores
func (sys *IAMSys) initStoreByRedis(objAPI ObjectLayer, redisClient *redis.Client) {
